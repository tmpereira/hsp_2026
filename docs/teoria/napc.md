# Análise de Componentes Principais Ajustada pelo Ruído (NA-PCA)

> **Para quem é este texto?** Este material é voltado para estudantes de graduação em Engenharia e Ciências Exatas com conhecimento básico de álgebra linear. O texto constrói o conceito de NA-PCA de forma progressiva, partindo do problema que ela resolve, passando pela PCA convencional e chegando à formulação completa do método.

---

## 1. O problema: ruído não é uniforme em espectros FT-IR
...
## 2. Revisão rápida: PCA convencional
...
## 4. Derivação matemática passo a passo
...
## 5. Resumo esquemático do algoritmo
...
## 6. NA-PCA vs. suavização convencional
...
## 7. Um detalhe importante: os "pixels vazios" são valiosos
...
## 8. Escolha do número de componentes $p$
...
## 9. Aplicação em células vivas: um exemplo concreto
